<cfcomponent extends="Controller">
	...
	<cffunction name="index">
		<cfset evals = model("Eval").findAll(include="quality")>
	</cffunction>
	...
	<cffunction name="show">
		...
		<!--- Find the record --->
    	<cfset eval = model("Eval").findByKey(key=params.key)>
	...
	<cffunction name="create">
		<cfparam name="params.interestid" default="0" />
	...
	<cffunction name="update">
		...
		<cfif eval.update(params.eval)>
			<cfset flashInsert(success="Eval #params.key# was updated successfully.")>	
            <cfset redirectTo(action="index")>
		<!--- Otherwise --->
		<cfelse>
			<cfset flashInsert(error="There was an error updating eval #params.key#.")>
	...
	<cffunction name="delete">
		...
		<cfif eval.delete()>
			<cfset flashInsert(success="Eval #params.key# was deleted successfully.")>	
            <cfset redirectTo(action="index")>
		<!--- Otherwise --->
		<cfelse>
			<cfset flashInsert(error="There was an error deleting the eval #params.key#.")>
			<cfset redirectTo(action="index")>
		</cfif>
	</cffunction>
